import math
import sys
from PyQt5.QtCore import Qt, QRectF,qInstallMessageHandler
from PyQt5.QtGui import QColor, QFont, QPainter, QRadialGradient, QPolygon, QPen
from PyQt5.QtWidgets import QApplication, QLCDNumber, QFrame,QMainWindow
...
class Dashboard(QMainWindow):
    def __init__(self, parent=None):
        ...
        # 颜色设置
        self.pieColorStart = QColor(20, 120, 130)  # 绿色
        self.pieColorMid = QColor(255, 155, 255)  # 黄色色
    ...
    def messageHandler(self,mode, context, message):
        if "QPainter::begin: Painter already active" in message:
            return
        else:
    ...
    def paintEvent(self, event):
        ...
        if self.currentValue>=0:
            ...
            formValue="%3d"% self.currentValue
    ...
    def lcd_init(self):
        ...
        self.lcd.setDigitCount(3)  # 最多显示3位数字
